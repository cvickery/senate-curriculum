    ...
    <form id='login-form' action='.' method='post'>
      <fieldset><legend>Sign In</legend>
        ...
        <div>
          ...
          <div class='instructions'>
            <p>
              Initially password is blank, and you may leave it that way if you want
              to.
            </p>
            <p>
              If you want to change your password, enter your current password, new
              password, and repeated new password below.
            </p>
            <p>
              ...
              Thus, if you type just one or more spaces for your password, you will revert
              to the blank password.
            </p>
            <p>
              Passwords are highly encrypted before being stored. Still, longer passwords
              are better than short ones; using punctuation symbols, digits, letters with
              diacritical marks, non-Latin letters, etc. is better than just plain letters.
            </p>
          </div>
...
/*  There are two different forms in this module: login-form gets an email address (or
 *  person's name if their QC email address is in "firstname.lastname@qc.cuny.edu
 *  format) and password. The email address gets looked up in the curric.people table
 ...
 */
  ...
  if ($form_name === login_which_department)
  {
    ...
    if ($dept_name)
    {
      ...
      login_form($pending_person->email);
    }
    else
    {
...
EOD;
        ...
        {
          //  new and repeat differ: present login form again, but with email filled in.
